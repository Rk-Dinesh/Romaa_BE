...
MainSchema.plugin(auditPlugin, { entity_type: "DrawingVsBOQ", entity_no_field: "tender_id" });

const DrawingVsBOQDEModel = mongoose.model("DrawingVsBOQDE", MainSchema);

export default DrawingVsBOQDEModel;
