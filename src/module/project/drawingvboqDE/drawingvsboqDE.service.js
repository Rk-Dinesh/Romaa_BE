...
import DrawingVsBOQDEModel from "./drawingvsboqDE.model.js";

class DrawingVsBOQDEService {
  ...
  static async bulkInsertCustomHeadingsFromCsv(tender_id, nametype, csvRows) {
    ...
    if (type === "abstract") {
      ...
      const detailedEstimate = await DrawingVsBOQDEModel.findOne({
        tender_id,
      });
      if (!detailedEstimate)
...
export default DrawingVsBOQDEService;
